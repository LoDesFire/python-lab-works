from task_1 import Report, Fraction, FracCollection, PickleSerializer
from task_1.csv_serializer import CSVSerializer
...
def main():
    pickleSerializer = PickleSerializer("task_1/data/binary.bin")
    csvSerializer = CSVSerializer("task_1/data/data.csv")
